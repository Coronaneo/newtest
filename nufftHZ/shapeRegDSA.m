...
% This code implements the algorithm in the paper "Recursive Diffeomorphism
% -Based Spectral Analysis for Generalized Mode Decomposition" by Gao Tang
% and Haizhao Yang.
%
% Input:
% sig         - given signal
...
% form the matrix fhatMat, which is the matrix H in the recursive DSA paper
vector1 = (0:L:N/2-L/2)';
...
SL2 = norm(shape)/sqrt(length(shape));
