c	subroutine nufft3dIII(nj,k,x,nk,iflag,ns,rt,tol,U,V,kksub,r)
c	implicit none
c
...
c	end subroutine
	...
	subroutine nufft3dIIIapp(nj,nk,plan,c,U,V,U1,
	...
	complex*16 U1(ns*ns*ns,r1),V1(r1,nj),M1(r,ns*ns*ns)
	...
	do i = 1,r
	call nufft3dIapp(nj,plan,M(i,:),U1,V1,xxsub,ns,kflag,r1,M1(i,:))
	enddo
